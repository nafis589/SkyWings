  ...
  return (
    <div className="px-4 sm:px-6 md:px-12 py-8 sm:py-12 md:py-16 bg-white">
          <div className="max-w-7xl mx-auto">
            {/* Label + Intro Text */}
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-55 mb-6 sm:mb-8 md:mb-12 pl-0 sm:pl-4 md:pl-20">
              ...
              <div className="w-full md:max-w-[60%]">
                <p className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-bold text-center md:text-left">
            ...
            <div className="iv flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mb-8 sm:mb-10 md:mb-12 pl-0 sm:pl-4 md:pl-85">
              ...
              <div className="bg-white pl-4 sm:pl-5 md:pl-7 border-l-4 border-sky-400 transition-shadow w-full sm:w-[350px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              <div className="bg-gray-50 px-4 sm:px-6 md:px-7 py-6 sm:py-10 md:py-16 lg:py-20 rounded-[30px] sm:rounded-[40px] md:rounded-[50px] lg:rounded-[60px] transition-shadow text-center">
              ...
              <div className="bg-gray-50 px-4 sm:px-6 md:px-7 py-6 sm:py-10 md:py-16 lg:py-20 rounded-[30px] sm:rounded-[40px] md:rounded-[50px] lg:rounded-[60px] transition-shadow text-center sm:col-span-2 md:col-span-1 mx-auto sm:mx-0 sm:w-1/2 md:w-full">
