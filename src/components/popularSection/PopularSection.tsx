...
import { fadeUpBlur, staggeredReveal, staggeredContainer } from '@/utils/scrollAnimationVariants';
    ...
    <div className="px-4 sm:px-6 lg:px-12 py-6 sm:py-8 lg:py-16 bg-gradient-to-br from-white to-white">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {[1, 2, 3].map((index) => (
              <motion.div key={index} variants={staggeredReveal} className="bg-white rounded-2xl sm:rounded-3xl md:rounded-4xl overflow-hidden transition-all hover:-translate-y-1">
