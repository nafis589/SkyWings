          ...
          <div className="tab flex flex-col md:flex-row items-center gap-6 sm:gap-8 md:gap-12 pl-0 sm:pl-6 md:pl-12 lg:pl-18">
            ...
            <div className="flex-1 flex flex-col justify-center h-auto md:h-[400px] lg:h-[500px] gap-4 sm:gap-6 md:gap-7 mt-6 md:mt-0">
              ...
              <div className="flex flex-col gap-3 sm:gap-4 md:gap-6">
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight text-gray-900 text-center sm:text-left">WANDERLUST WITH</h2>
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4 mobile-c">
                  ...
                  <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight text-gray-900 text-center sm:text-left">SKYWINGS</h2>
                </div>
              </div>
            </div>
          </div>
